...
public class ExcelMapper
{
    ...
    public IEnumerable<T> Fetch<T>(string file, string sheetName, Func<string, int, object, object> valueParser = null)
    {
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable Fetch(string file, Type type, string sheetName, Func<string, int, object, object> valueParser = null)
    {
        Workbook = WorkbookFactory.Create(file);
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable<dynamic> Fetch(string file, string sheetName, Func<string, int, object, object> valueParser = null)
    {
        Workbook = WorkbookFactory.Create(file);
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable<T> Fetch<T>(string file, int sheetIndex, Func<string, int, object, object> valueParser = null)
    {
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable Fetch(string file, Type type, int sheetIndex, Func<string, int, object, object> valueParser = null)
    {
        Workbook = WorkbookFactory.Create(file);
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable<dynamic> Fetch(string file, int sheetIndex, Func<string, int, object, object> valueParser = null)
    {
        Workbook = WorkbookFactory.Create(file);
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable<T> Fetch<T>(Stream stream, string sheetName, Func<string, int, object, object> valueParser = null)
    {
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable Fetch(Stream stream, Type type, string sheetName, Func<string, int, object, object> valueParser = null)
    {
        Workbook = WorkbookFactory.Create(stream);
        return Fetch(type, sheetName, valueParser);
    }
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable<dynamic> Fetch(Stream stream, string sheetName, Func<string, int, object, object> valueParser = null)
    {
        Workbook = WorkbookFactory.Create(stream);
        return Fetch(sheetName, valueParser);
    }
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable<T> Fetch<T>(Stream stream, int sheetIndex, Func<string, int, object, object> valueParser = null)
    {
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable Fetch(Stream stream, Type type, int sheetIndex, Func<string, int, object, object> valueParser = null)
    {
        Workbook = WorkbookFactory.Create(stream);
        return Fetch(type, sheetIndex, valueParser);
    }
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable<dynamic> Fetch(Stream stream, int sheetIndex, Func<string, int, object, object> valueParser = null)
    {
        Workbook = WorkbookFactory.Create(stream);
        return Fetch(sheetIndex, valueParser);
    }
    ...
    public IEnumerable<T> Fetch<T>(string sheetName, Func<string, int, object, object> valueParser = null)
    {
    ...
    /// <returns>The objects read from the Excel file.</returns>
    /// <exception cref="System.ArgumentOutOfRangeException">Thrown when a sheet is not found</exception>
    public IEnumerable Fetch(Type type, string sheetName, Func<string, int, object, object> valueParser = null)
    {
        PrimitiveCheck(type);
    ...
    /// <returns>The objects read from the Excel file.</returns>
    /// <exception cref="System.ArgumentOutOfRangeException">Thrown when a sheet is not found</exception>
    public IEnumerable<dynamic> Fetch(string sheetName, Func<string, int, object, object> valueParser = null)
    {
        var sheet = Workbook.GetSheet(sheetName) ?? throw new ArgumentOutOfRangeException(nameof(sheetName), sheetName, "Sheet not found");
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable<T> Fetch<T>(int sheetIndex = 0, Func<string, int, object, object> valueParser = null)
    {
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable Fetch(Type type, int sheetIndex = 0, Func<string, int, object, object> valueParser = null)
    {
        PrimitiveCheck(type);
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public IEnumerable<dynamic> Fetch(int sheetIndex = 0, Func<string, int, object, object> valueParser = null)
    {
        var sheet = Workbook.GetSheetAt(sheetIndex);
        return Fetch(sheet, valueParser);
    }

    IEnumerable<T> Fetch<T>(ISheet sheet, Func<string, int, object, object> valueParser = null)
    {
        return Fetch(sheet, typeof(T), valueParser).OfType<T>();
    }

    IEnumerable Fetch(ISheet sheet, Type type, Func<string, int, object, object> valueParser = null)
    {
    ...
    IEnumerable<dynamic> Fetch(ISheet sheet, Func<string, int, object, object> valueParser = null) =>
        Fetch(sheet, type: null, valueParser).Cast<dynamic>();

    private object MapCells(Type type, Func<string, int, object, object> valueParser, TypeMapper typeMapper,
        ...
        foreach (var (columnIndex, columnInfos) in columns)
        {
            ...
            if (cell != null && (!SkipBlankCells || !IsCellBlank(cell)))
            {
                foreach (var ci in columnInfos)
                {
                    ...
                    {
                        if (valueParser != null)
                            cellValue = valueParser(string.IsNullOrWhiteSpace(ci.Name) ? columnIndex.ToString() : ci.Name, cell.RowIndex, cellValue);
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public async Task<IEnumerable<T>> FetchAsync<T>(string file, string sheetName, Func<string, int, object, object> valueParser = null)
    {
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public async Task<IEnumerable<dynamic>> FetchAsync(string file, string sheetName, Func<string, int, object, object> valueParser = null)
    {
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public async Task<IEnumerable> FetchAsync(string file, Type type, string sheetName, Func<string, int, object, object> valueParser = null)
    {
        using var ms = await ReadAsync(file);
        ms.Position = 0;
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public async Task<IEnumerable<T>> FetchAsync<T>(string file, int sheetIndex = 0, Func<string, int, object, object> valueParser = null)
    {
        using var ms = await ReadAsync(file);
        ms.Position = 0;
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public async Task<IEnumerable<dynamic>> FetchAsync(string file, int sheetIndex = 0, Func<string, int, object, object> valueParser = null)
    {
        using var ms = await ReadAsync(file);
        ms.Position = 0;
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public async Task<IEnumerable> FetchAsync(string file, Type type, int sheetIndex = 0, Func<string, int, object, object> valueParser = null)
    {
        using var ms = await ReadAsync(file);
        ms.Position = 0;
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public async Task<IEnumerable<T>> FetchAsync<T>(Stream stream, string sheetName, Func<string, int, object, object> valueParser = null)
    {
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public async Task<IEnumerable<dynamic>> FetchAsync(Stream stream, string sheetName, Func<string, int, object, object> valueParser = null)
    {
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public async Task<IEnumerable> FetchAsync(Stream stream, Type type, string sheetName, Func<string, int, object, object> valueParser = null)
    {
        using var ms = await ReadAsync(stream);
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public async Task<IEnumerable<T>> FetchAsync<T>(Stream stream, int sheetIndex = 0, Func<string, int, object, object> valueParser = null)
    {
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public async Task<IEnumerable<dynamic>> FetchAsync(Stream stream, int sheetIndex = 0, Func<string, int, object, object> valueParser = null)
    {
        using var ms = await ReadAsync(stream);
    ...
    /// <param name="valueParser">Allow value parsing</param>
    /// <returns>The objects read from the Excel file.</returns>
    public async Task<IEnumerable> FetchAsync(Stream stream, Type type, int sheetIndex = 0, Func<string, int, object, object> valueParser = null)
    {
        using var ms = await ReadAsync(stream);
    ...
    public void Save<T>(string file, IEnumerable<T> objects, string sheetName, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public void Save<T>(string file, IEnumerable<T> objects, int sheetIndex = 0, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        using var fs = File.Open(file, FileMode.Create, FileAccess.Write);
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public void Save<T>(Stream stream, IEnumerable<T> objects, string sheetName, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        CreateWorkbook(xlsx);
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public void Save<T>(Stream stream, IEnumerable<T> objects, int sheetIndex = 0, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        CreateWorkbook(xlsx);
        ISheet sheet;
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public void Save(string file, string sheetName, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        using var fs = File.Open(file, FileMode.Create, FileAccess.Write);
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public void Save(string file, int sheetIndex = 0, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        using var fs = File.Open(file, FileMode.Create, FileAccess.Write);
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public void Save(Stream stream, string sheetName, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        CreateWorkbook(xlsx);
        var sheet = Workbook.GetSheet(sheetName);
        sheet ??= Workbook.CreateSheet(sheetName);
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public void Save(Stream stream, int sheetIndex = 0, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        CreateWorkbook(xlsx);
        var sheet = Workbook.GetSheetAt(sheetIndex);
        sheet ??= Workbook.CreateSheet();
    ...
    void Save(Stream stream, ISheet sheet, Func<string, int, object, object> valueConverter = null)
    {
    ...
    void Save<T>(Stream stream, ISheet sheet, IEnumerable<T> objects, Func<string, int, object, object> valueConverter = null)
    {
    ...
    private void SetCells(TypeMapper typeMapper,
        ...
        Func<string, int, object, object> valueConverter = null)
    {
    ...
    private void SetCell<T>(Func<string, int, object, object> valueConverter, T objInstance, ICell cell, ColumnInfo ci, Dictionary<int, ICellStyle> cellStyles)
    {
        Type oldType = null;
        object val = ci.GetProperty(objInstance);
        if (valueConverter != null)
        {
            val = valueConverter(ci.Name, cell.RowIndex, val);
        }
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public async Task SaveAsync<T>(string file, IEnumerable<T> objects, string sheetName, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public async Task SaveAsync<T>(string file, IEnumerable<T> objects, int sheetIndex = 0, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        using var ms = new MemoryStream();
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public async Task SaveAsync<T>(Stream stream, IEnumerable<T> objects, string sheetName, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        using var ms = new MemoryStream();
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public async Task SaveAsync<T>(Stream stream, IEnumerable<T> objects, int sheetIndex = 0, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        using var ms = new MemoryStream();
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public async Task SaveAsync(string file, string sheetName, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        using var ms = new MemoryStream();
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public async Task SaveAsync(string file, int sheetIndex = 0, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        using var ms = new MemoryStream();
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public async Task SaveAsync(Stream stream, string sheetName, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        using var ms = new MemoryStream();
    ...
    /// <param name="xlsx">if set to <c>true</c> saves in .xlsx format; otherwise, saves in .xls format.</param>
    /// <param name="valueConverter">converter receiving property name and value</param>
    public async Task SaveAsync(Stream stream, int sheetIndex = 0, bool xlsx = true, Func<string, int, object, object> valueConverter = null)
    {
        using var ms = new MemoryStream();
